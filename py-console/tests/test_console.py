...
class TestConsole(unittest.TestCase):
    ...
    def test_parse_port(self):
        response = b'C\x01xinuserver.cs.purdue.edu\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x000\x00\x00\x00\x00\x00\x00\x00\x00\x0048670 : connect port\x00'
        self.assertEqual(xkdb.parse_port(response), 48670)

        response = b'A\x01xinuserver.cs.purdue.edu\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x000\x00\x00\x00\x00\x00\x00\x00\x00\x0048670 : connect port\x00'
